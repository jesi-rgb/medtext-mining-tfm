...
\begin{itemize}
    ...
    \item \textbf{Máquinas de Soporte Vectorial}: Las Support Vector Machines (SVM) son modelos muy conocidos de aprendizaje supervisado para clasificación y regresión. Su funcionamiento en clasificación de texto ha sido demostara
\end{itemize}
