...
Gracias a \jesitt{pytorch}\cite{pytorch} y \jesitt{transformers}\cite{WolfEtal2020Transformers}, podemos reentrenar nuestro modelo GPT-2 con nuestros datos, como se puede ver en \href{https://huggingface.co/transformers/custom_datasets.html}{Fine-tuning with custom datasets}. 
...
\subsubsection{Greedy search and beam search}
